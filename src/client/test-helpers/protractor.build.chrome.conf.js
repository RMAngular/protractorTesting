		...
		var capsPromise = browser.getCapabilities();
	 	...
	 	capsPromise.then(function(caps){
			var browserName = caps.caps_.browserName.toUpperCase().replace(' ','_'),
				...
				junitReporter = new jasmine.JUnitXmlReporter('protractor_output', true, true, prePendStr),
				htmlReporter = new HtmlReporter({baseDirectory: './protractor_html/' + browserName});
