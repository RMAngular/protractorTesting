	...
	onPrepare: function(){
		...
		var capsPromise = browser.getCapabilities();
	 	capsPromise.then(function(caps){
			...
			var prePendStr = "TEST-" + browserName + "-" + browserVersion + "-";
			jasmine.getEnv().addReporter(
				new jasmine.JUnitXmlReporter('.', true, true, prePendStr));
			jasmine.getEnv().addReporter(
					new HtmlReporter({baseDirectory: './protractor_html/'+browserName})
			);
		});
